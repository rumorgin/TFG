...
class CIFAR10(VisionDataset):
    ...
    def __init__(self, root, train=True, transform=None, target_transform=None,
        ...
        self.WORD_EMEDDING_PATH = os.path.join(root, 'cifar-100-python')
        if download:
            self.download()
        ...
        word2vec_csv=os.path.join(self.WORD_EMEDDING_PATH, 'cifar100_embeddings.csv')
    ...
    def __getitem__(self, index):
        ...
        word_embedding = torch.tensor(ast.literal_eval(self.word_embedding[str(target.item())]))

        return img, target, word_embedding
