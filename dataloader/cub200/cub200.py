...
class CUB200(Dataset):
    ...
    def __init__(self, root='./', train=True,
        ...
        self.WORD_EMEDDING_PATH = os.path.join(root, 'CUB_200_2011')
        ...
        word2vec_csv=os.path.join(self.WORD_EMEDDING_PATH, 'cub_embeddings.csv')
    ...
    def __getitem__(self, i):
        ...
        word_embedding = torch.tensor(ast.literal_eval(self.word_embedding[str(targets)]))
